...
?>
        <h2 size="1" style="font-family: Verdana, Arial, Helvetica, sans-serif;"> Quer adicionar um novo usuário? </h2>
        <button size="1" style="font-family: Verdana, Arial, Helvetica, sans-serif;" class="styled-button" onclick="window.location.href='add-user.php'"> Clique Aqui </button>


        <center>
            <h1> Consulta de Usuários Ativos</h1>
        </center>
        ...
        <table width="80%" border="0" align="center">
            <tr bgcolor='#CCCCCC'>
                ...
                <td width="118">
                    <font size="3" face="Verdana, Arial, Helvetica, sans-serif"><strong> Nome Completo: </strong></font>
                </td>
                ...
                <td>
                    <font size="3" face="Verdana, Arial, Helvetica, sans-serif"> <strong> E-mail: </strong> </font>
                </td>
            ...
            <?php
                ...
                foreach ($users as $user){
                    echo "<tr>";
                    echo "<td size = '1' style='font-famyly: Verdana, Arial, Helvetica, sans-serif;''>" . $user['id'] . "</td>";
                    echo "<td size = '1' style='font-famyly: Verdana, Arial, Helvetica, sans-serif;''>" . $user['name'] . "</td>";
                    echo "<td size = '1' style='font-famyly: Verdana, Arial, Helvetica, sans-serif;''>" . $user['age'] . "</td>";
                    echo "<td size = '1' style='font-famyly: Verdana, Arial, Helvetica, sans-serif;''>" . $user['email'] . "</td>";
                    echo "<td size='1' style='font-family: Verdana, Arial, Helvetica, sans-serif;''><a href=\"edit-user.php?id=$user[id]\"onClick=\"return confirm('Tem certeza de que deseja editar?')\">Editar</a> | <a href=\"delete-user.php?id=$user[id]\"onClick=\"return confirm('Tem certeza de que deseja excluir?')\">Deletar | <a href=\"../index.php\"onClick=\"return confirm('Tem certeza de que deseja adicionar?')\">Adicionar</a> | <a href=\"add-shop.php?id=$user[id]\"onClick=\"return confirm('Tem certeza de que comprar?')\">Realizar compra</a> </td>" ;
                    echo "</tr>";
                } 
            
            ?>
        </table>
        <img src="imgs/pessoas" height="5%" width="30%" style="margin-top: 0%; margin-left: 840px;  opacity: 0.6;">
    </body>
</html>
