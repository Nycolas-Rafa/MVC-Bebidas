...
$drinks = $drinkController ->viewDrinks();
?>
        <h2 size="1" style="font-family: Verdana, Arial, Helvetica, sans-serif;"> Quer adicionar uma nova bebida? </h2>
        <button size="1" style="font-family: Verdana, Arial, Helvetica, sans-serif;" class="styled-button" onclick="window.location.href='add-drink.php'"> Clique Aqui </button>


        <center>
            <h1> Consultar Bebidas Salvas </h1>
        </center>
        ...
        <table width="80%" border="0" align="center">
            <tr bgcolor='#CCCCCC'>
                ...
                <td width="118">
                    <font size="3" face="Verdana, Arial, Helvetica, sans-serif"><strong> Bebida: </strong></font>
                </td>
            ...
            <?php
                ...
                foreach ($drinks as $drink){
                    echo "<tr>";
                    echo "<td size = '1' style='font-famyly: Verdana, Arial, Helvetica, sans-serif;''>" . $drink['idDrinks'] . "</td>";
                    echo "<td size = '1' style='font-famyly: Verdana, Arial, Helvetica, sans-serif;''>" . $drink['drink'] . "</td>";
                    echo "<td size = '1' style='font-famyly: Verdana, Arial, Helvetica, sans-serif;''>" . $drink['priceDrinks'] . "</td>";
                  
                    echo "<td size='1' style='font-family: Verdana, Arial, Helvetica, sans-serif;''><a href=\"edit-drink.php?idDrinks=$drink[idDrinks]\"onClick=\"return confirm('Tem certeza de que deseja editar?')\">Editar</a> | <a href=\"delete-drink.php?idDrinks=$drink[idDrinks]\"onClick=\"return confirm('Tem certeza de que deseja excluir?')\">Deletar | <a href=\"../new-drink.php\"onClick=\"return confirm('Tem certeza de que deseja adicionar?')\">Adicionar</a></td>";
                    echo "</tr>";
                } 
        ...
        <img src="imgs/tacamartini.gif" height="5%" width="30%" style="margin-top: 0%; margin-left: 840px;">
