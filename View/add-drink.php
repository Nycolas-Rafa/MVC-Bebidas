    ...
    <form action="" method="post" name="form1">
        ...
        <table width="588" border="0" align="center">
            <tr>
                ...
                <td width="460">
                    <input name="drink" type="text" class="formbutton" id="nome" size="52" maxlength="150">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <button type="submit" formaction='../View/view-drinks.php'> Consultar Bebidas já cadastradas </button>
                </td>
            </tr>
        </table>
    </form>
